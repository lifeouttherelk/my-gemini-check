...
const App: FC = () => {
  ...
  const [copyrightDescription, setCopyrightDescription] = useState<
    string | null
  >(null);
  const [zedgeViolationStatus, setZedgeViolationStatus] =
    useState<Status>(null);
  const [zedgeViolationDescription, setZedgeViolationDescription] = useState<
    string | null
  >(null);
  const [womenPolicyStatus, setWomenPolicyStatus] = useState<Status>(null);
  const [womenPolicyDescription, setWomenPolicyDescription] = useState<
    string | null
  >(null);
  const [kidsViolationStatus, setKidsViolationStatus] = useState<Status>(null);
  const [kidsViolationDescription, setKidsViolationDescription] = useState<
    string | null
  >(null);
  ...
  const analyzeImageWithAI = async () => {
    ...
    try {
      ...
      const fullPrompt = `
        ...
        The title, description, and tags should NOT contain any of the following words or concepts: ${forbiddenWords.join(
          ", "
        )} or any film names or TV season names.
      ...
      if (
        parsedJson.status === "pass" &&
        parsedJson.zedgeViolationStatus === "pass" &&
        parsedJson.womenPolicyStatus === "pass" &&
        parsedJson.kidsViolationStatus === "pass"
      ) {
  ...
  const getStatusIcon = (status: Status) => {
    if (status === "found")
      return (
        ...
        >
          <path d="M20.25 15.69l-1.3-1.63a1 1 0 0 0-.82-.35H5.87a1 1 0 0 0-.82.35L3.75 15.69a1 1 0 0 0 .15 1.48L12 21.68l8.1-4.51a1 1 0 0 0 .15-1.48zM12 8v4" />
          <path d="M12 16h.01" />
        </svg>
      );
    if (status === "pass")
      return (
        <svg
          ...
          strokeLinejoin="round"
        >
          <path d="M20.25 15.69l-1.3-1.63a1 1 0 0 0-.82-.35H5.87a1 1 0 0 0-.82.35L3.75 15.69a1 1 0 0 0 .15 1.48L12 21.68l8.1-4.51a1 1 0 0 0 .15-1.48zM9 12l2 2 4-4" />
        </svg>
      );
    return null;
  };
    ...
    <div className="app-container">
      <header className="app-header">
        <div className="app-header-content">
          ...
          <div>
            <h1>Copyright Checking Assistant</h1>
            <p>Analyze copyright and policy compliance for Zedge.</p>
          </div>
        </div>
      </header>
          ...
          <PolicyIcon
            ...
            icon={
              ...
              >
                ...
                <path d="M14.5 9a3.5 3.5 0 1 0 0 6h1a2 2 0 0 0 0-4h-1" />
              </svg>
            }
          />
          <PolicyIcon
            status={zedgeViolationStatus}
            label="Zedge"
            icon={
              <svg
                xmlns="http://www.w3.org/2000/svg"
                ...
                strokeLinejoin="round"
              >
                <path d="M20 13V7a4 4 0 0 0-2-3.46l-6-3.46-6 3.46A4 4 0 0 0 4 7v6l8 4 8-4Z" />
                <path d="m9 12 2 2 4-4" />
              </svg>
            }
          />
          <PolicyIcon
            status={womenPolicyStatus}
            label="Women"
            icon={
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          <PolicyIcon
            ...
            icon={
              ...
              >
                ...
                <path d="M12 18v2" />
                <path d="M12 18c-3.6 0-6.75-1.02-9-2.76.7-.22 1.4-.3 2-.3 1 0 2-.2 3-.5a2.4 2.4 0 0 1 2-2 2.4 2.4 0 0 1 2 2c1 .3 2 .5 3 .5s1.3.08 2 .3c2.25 1.74 5.4 2.76 9 2.76h-2" />
              </svg>
            }
          />
        </div>
      ...
      <main className="main-content">
        ...
        >
          ...
          {imageUrl ? (
            ...
            <>
              ...
              <p className="placeholder-text-lg">
        ...
        <div className="analysis-results">
              ...
              {loading ? (
                ...
                <>
                  <svg
                    ...
                    strokeLinejoin="round"
                  >
                    <path d="M9.9 14.2l-5.7 4.5 1.5-6.7-5.7-4.5h6.6L12 2l2.4 5.5h6.6l-5.7 4.5 1.5 6.7z" />
                    <path d="M22 22 19.5 19.5" />
                    <path d="M18.8 13.4 22 10" />
                    <path d="M13.4 18.8 10 22" />
                  </svg>
                  Analysis
                </>
              )}
          ...
          {copyrightStatus === "pass" &&
            zedgeViolationStatus === "pass" &&
            womenPolicyStatus === "pass" &&
            kidsViolationStatus === "pass" &&
            title && (
              <div className="metadata-card">
                ...
                <div className="metadata-field">
                  ...
                  <div className="metadata-actions">
                    <button
                      onClick={() => handleTextToSpeech(title)}
                      disabled={isSpeaking}
                      className="metadata-btn tts-btn"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="16"
                    ...
                    <button
                      ...
                      className="metadata-btn copy-btn"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="16"
                      ...
                      >
                        <rect
                          ...
                          ry="2"
                        />
                        <path d="M4 16c-1.1-1.2-2.1-3.6-2-6s1-4 2-5" />
                      </svg>
                    </button>
                  </div>
                </div>
                <div className="metadata-field">
                  ...
                  <div className="metadata-actions">
                    <button
                      onClick={() => handleTextToSpeech(imageDescription)}
                      disabled={isSpeaking}
                      className="metadata-btn tts-btn"
                    >
                      <svg
          ...
          {copyrightStatus && (
            <div
              className={`notification-card ${
                copyrightStatus === "pass" ? "pass-card" : "found-card"
              }`}
            >
              <h3>
                {getStatusIcon(copyrightStatus)}Copyright Status:{" "}
                {copyrightStatus === "pass" ? "Pass" : "Violation"}
              </h3>
          ...
          {zedgeViolationStatus && (
            <div
              className={`notification-card ${
                zedgeViolationStatus === "pass" ? "pass-card" : "found-card"
              }`}
            >
              <h3>
                {getStatusIcon(zedgeViolationStatus)}Zedge Policy:{" "}
                {zedgeViolationStatus === "pass" ? "Pass" : "Violation"}
              </h3>
              <p>{zedgeViolationDescription}</p>
            </div>
          )}
          {womenPolicyStatus && (
            <div
              className={`notification-card ${
                womenPolicyStatus === "pass" ? "pass-card" : "found-card"
              }`}
            >
              <h3>
                {getStatusIcon(womenPolicyStatus)}Women Policy:{" "}
                {womenPolicyStatus === "pass" ? "Pass" : "Violation"}
              </h3>
              <p>{womenPolicyDescription}</p>
            </div>
          )}
          {kidsViolationStatus && (
            <div
              className={`notification-card ${
                kidsViolationStatus === "pass" ? "pass-card" : "found-card"
              }`}
            >
              <h3>
                {getStatusIcon(kidsViolationStatus)}Kids Policy:{" "}
                {kidsViolationStatus === "pass" ? "Pass" : "Violation"}
              </h3>
              <p>{kidsViolationDescription}</p>
            </div>
          )}
          {error && (
